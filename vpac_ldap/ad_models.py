...
class person(ad.person, rfc.organizationalPerson, rfc.inetOrgPerson, ad.user, common.personMixin, adUserMixin):
    ...
    managed_by = tldap.manager.ManyToOneDescriptor('manager', 'vpac_ldap.ad_models.person', 'dn')
    manager_of = tldap.manager.OneToManyDescriptor('dn', 'vpac_ldap.ad_models.person', 'manager')
...
class account(person, ad.posixAccount, common.accountMixin):
    ...
    managed_by = tldap.manager.ManyToOneDescriptor('manager', 'vpac_ldap.ad_models.account', 'dn')
    manager_of = tldap.manager.OneToManyDescriptor('dn', 'vpac_ldap.ad_models.account', 'manager')
